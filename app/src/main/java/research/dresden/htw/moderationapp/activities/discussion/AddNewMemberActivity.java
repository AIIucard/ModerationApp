...
public class AddNewMemberActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        addNewMemberButton = findViewById(R.id.button_add_new_member);
        addNewMemberButton.setEnabled(false);
        ...
        addNewMemberButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (memberList != null) {
                    ...
                    selectedMembersForDiscussionList.add(newMember);
                    ...
                    finish();
                    Toast.makeText(AddNewMemberActivity.this, getString(R.string.add_toast_member, newMember.getName(), newMember.getId()), Toast.LENGTH_LONG).show();
                }
            }
        });
    }
    ...
    private void updateAddButton() {
        ...
        if (isTitleSet && isNameSet && isOrganisationSet && isRoleSet) {
            addNewMemberButton.setEnabled(true);
        } else {
            addNewMemberButton.setEnabled(false);
        }
    }
