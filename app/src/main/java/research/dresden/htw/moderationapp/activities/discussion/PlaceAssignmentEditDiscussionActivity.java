...
public class PlaceAssignmentEditDiscussionActivity extends AppCompatActivity {
    ...
    private void updateButton() {
        ...
        if (!(place1Spinner.getSelectedItemPosition() >= place1SpinnerAdapter.getCount()) && !(oldSelectedPlace1SpinnerValue.equals(place1Spinner.getSelectedItem()))) {
            valueChanged = true;
        }
        if (!(place2Spinner.getSelectedItemPosition() >= place2SpinnerAdapter.getCount()) && !(oldSelectedPlace2SpinnerValue.equals(place2Spinner.getSelectedItem()))) {
            valueChanged = true;
        }
        if (!(place3Spinner.getSelectedItemPosition() >= place3SpinnerAdapter.getCount()) && !(oldSelectedPlace3SpinnerValue.equals(place3Spinner.getSelectedItem()))) {
            valueChanged = true;
        }
        if (!(place4Spinner.getSelectedItemPosition() >= place4SpinnerAdapter.getCount()) && !(oldSelectedPlace4SpinnerValue.equals(place4Spinner.getSelectedItem()))) {
            valueChanged = true;
        }
        if (!(place5Spinner.getSelectedItemPosition() >= place5SpinnerAdapter.getCount()) && !(oldSelectedPlace5SpinnerValue.equals(place5Spinner.getSelectedItem()))) {
            valueChanged = true;
        }
        completeButton = findViewById(R.id.complete_edit_place_assignment_discussion);
    ...
    private void initValues() {
        if (discussionToEditTempObj != null) {
            if (discussionToEditTempObj.getMemberList() != null) {
                ...
                place1Spinner.setSelection(place1SpinnerAdapter.getPosition(oldSelectedPlace1SpinnerValue));
                place2Spinner.setSelection(place2SpinnerAdapter.getPosition(oldSelectedPlace2SpinnerValue));
                place3Spinner.setSelection(place3SpinnerAdapter.getPosition(oldSelectedPlace3SpinnerValue));
                place4Spinner.setSelection(place4SpinnerAdapter.getPosition(oldSelectedPlace4SpinnerValue));
                place5Spinner.setSelection(place5SpinnerAdapter.getPosition(oldSelectedPlace5SpinnerValue));
            }
        }
    }
}